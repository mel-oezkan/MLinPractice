...
python -m code.preprocessing.run_preprocessing data/preprocessing/labeled.csv data/preprocessing/preprocessed.csv --punctuation --sentiment --tokenize -e data/preprocessing/pipeline.pickle
