...
from code.util import COLUMN_LINKS, COLUMN_PUNCTUATION, COLUMN_TWEET, SUFFIX_TOKENIZED
...
parser.add_argument("-l", "--links", action = "store_true", help = "removes links in the tweet")
...
parser.add_argument("-s", "--stopword", action = "store_true", help = "removes stopwords given tokenized inputs")
...
if args.tokenize:
    ...
    if args.stopword:
        # depends on the tokenized inputs 
        preprocessors.append(StopWords(args.tokenize_input + SUFFIX_TOKENIZED))
